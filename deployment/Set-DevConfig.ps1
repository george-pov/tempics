...
param(
    ...
    [string]$UiStorageName = 'sttempicsuidev',
...
$context = Get-DevContext -SubscriptionId $SubscriptionId -ResourceGroup $ResourceGroup -IdentityName $IdentityName -FunctionAppName $FunctionAppName -UiStorageName $UiStorageName -Repository $Repository -EnvironmentName $EnvironmentName
...
try {
    ...
    Write-Output 'Verified dev main-only policy and nine deployment variables.'
}
